...
export default function Header() {
  ...
  const navigation = [
    ...
    { 
      name: 'Community', 
      href: '#community',
      dropdown: ['Leaderboard', 'Forums', 'Projects', 'Shoutouts']
    },
    { 
      name: 'More', 
      href: '#more',
      dropdown: ['Our Vision', 'Work With Us', 'Contact Us', 'Donate']
    }
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-1 text-sm">
                <button className="px-2 py-1 text-primary font-medium">EN</button>
                <span className="text-muted-foreground">|</span>
                <button className="px-2 py-1 text-muted-foreground hover:text-primary transition-colors">HI</button>
                <span className="text-muted-foreground">|</span>
                <button className="px-2 py-1 text-muted-foreground hover:text-primary transition-colors">TA</button>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-1 text-sm">
                    <button className="px-2 py-1 text-primary font-medium">EN</button>
                    <span>|</span>
                    <button className="px-2 py-1 text-muted-foreground">HI</button>
                    <span>|</span>
                    <button className="px-2 py-1 text-muted-foreground">TA</button>
                  </div>
                </div>
                <button
                  onClick={() => setIsSignInOpen(true)}
